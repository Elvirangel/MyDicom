...
def display():
    ...
    # plt.title(filename+"  Oringal DICOM")
    # # plt.imsave("new Image3",newImage)
    # # plt.savefig("new Image.png",bbox_inches='tight')
    # # cv2.imwrite("newImage22.png",newImage)
    # # plt.show()
    ...
    # plt.figure(2)
    # plt.imshow(newImage, cmap=plt.cm.gray, origin='lower')
    # plt.title(filename+"  Unflod DICOM")


    plt.figure(3)
    plt.title(filename+"  path of unflod")
    plt.imshow(minPath2, cmap='gray', origin='lower')
    plt.savefig(str(fileNumber) + "Unflod.png", bbox_inches='tight')


    plt.figure(4)
    plt.title(filename+"  path of oringal")
    plt.imshow(minPath, cmap='gray', origin='lower')
    ...
    plt.figure(5)
    # plt.figimage(imArray,origin='upper',alpha=1)
    plt.title(filename+"  Oringal + Unflod")
    plt.imshow(newImage, cmap='gray', origin='upper', alpha=1)
    plt.imshow(minPath2, cmap='YlGn', origin='upper', alpha=0.4)
    plt.savefig(str(fileNumber)+ "Oringal+Unflod.png", bbox_inches='tight')
    # plt.scatter(Y,X,c='r',s=1,)
    ...
    plt.imshow(imArray, cmap='gray', origin='upper', alpha=1)
    plt.imshow(minPath, cmap='YlGn', origin='upper', alpha=0.4)
    plt.title(filename+"  Oringal + Path")
    # plt.scatter(Y,X,c='r',s=1,)
    plt.savefig(str(fileNumber)+"Oringal+Path.png",bbox_inches='tight')
    plt.show()
...
def display2():
    ...
    plt.imshow(newImage, cmap='gray', origin='upper', alpha=1)
    plt.imshow(minPath3, cmap='YlGn', origin='upper', alpha=0.4)
